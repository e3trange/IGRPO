...
class SearchEnv(BaseTextEnv):
    ...
    def fork_from(self, another_env: "SearchEnv") -> None:
        self.ground_truth = another_env.ground_truth
        self.max_turns = another_env.max_turns
        self.data_source = another_env.data_source
        self.chat_history = deepcopy(another_env.chat_history)
        self.done = another_env.done
        self.turns = another_env.turns